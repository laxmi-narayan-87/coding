...
delone_bttn = tkinter.Button(
    ...
    root, text="Done Task", bg="white",fg="green", width=20,height=2, command=delete_one)
...
sort_asc = tkinter.Button(root, text="sort (ASC)",bg="white",fg="green", width=20,height=2, command=sort_asc)
...
random_bttn = tkinter.Button(
    ...
    root, text="random task", bg="White",fg="green", width=20,height=2, command=random_task)

random_bttn.grid(row=6, column=0)

number_task = tkinter.Button(

    root, text="Number of Task", bg="white",fg="green", width=20,height=2, command=number_task)
...
save_button = tkinter.Button(
    ...
    root, text="save TodoList", bg="white",fg="green" ,width=20,height=2, command=save_act)

save_button.grid(row=10, column=1)

load_button = tkinter.Button(

    root, text="Load LastTodolist", bg="white",fg="green", width=20,height=2, command=load_act)
