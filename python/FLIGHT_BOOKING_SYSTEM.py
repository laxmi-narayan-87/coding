...
mycon=mys.connect(host="localhost",user="root",passwd="qwertyuiop",database="flight")
...
def add():
    query = "create table if not exists flightbook(flightno integer, bcity varchar(15), dcity varchar(15), jtime time, fare integer airline varchar(10))"
